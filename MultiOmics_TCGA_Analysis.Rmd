...
Het_LowM1=read.table ("Heterogeneity_low M1.tsv", sep= "\t", header=T)
Het_HighM1= read.table ("Heterogeneity_high M1.tsv", sep= "\t", header=T)

IPS_HighM1=read.table ("immunotherapyscores_high M1.tsv", sep= "\t", header=T)
IPS_LowM1= read.table ("immunotherapyscores_low M1.tsv", sep= "\t", header=T)
